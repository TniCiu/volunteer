...
const UpdateVolunteer = ({ volunteer, onClose, onUpdate }) => {
  ...
  const [avatarPreview, setAvatarPreview] = useState(volunteer?.avatar || null);
  ...
  useEffect(() => {
    if (volunteer) {
      ...
      setAvatarPreview(volunteer.avatar || null);
    }
  }, [volunteer]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (onUpdate) {
        await onUpdate(volunteer.id, updateData);
      }
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
          ...
          <Box>
            ...
            <Typography variant="body1" sx={{ opacity: 0.9 }}>
              Chỉnh sửa thông tin tình nguyện viên: {volunteer?.name}
            </Typography>
          </Box>
        </Box>
      </Box>
          ...
          <form onSubmit={handleSubmit}>
            <Box display="flex" flexDirection="column" gap={3}>
              ...
              <Box sx={{ display: 'flex', gap: 2, justifyContent: 'flex-end' }}>
                ...
                >
                  {loading ? 'Đang cập nhật...' : 'Cập nhật tình nguyện viên'}
                </Button>
              </Box>
            </Box>
          </form>
